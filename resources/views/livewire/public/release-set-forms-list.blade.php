<div class="space-y-5">
        ...
        <div class="p-6 sm:p-8">
            ...
            <div class="mt-5 rounded-xl bg-slate-50 border border-slate-200 px-4 py-3">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-xs font-medium text-slate-500">Your overall progress</span>
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="flex items-center gap-2 flex-wrap">
                                ...
                                @if ($release->is_required ?? true)
                                    <span class="text-xs font-medium text-red-500 bg-red-50 border border-red-100 rounded-md px-2 py-0.5">Required</span>
                                @else
                                    <span class="text-xs font-medium text-slate-400 bg-slate-50 border border-slate-100 rounded-md px-2 py-0.5">Optional</span>
                                @endif
                            </div>
    ...
    @empty
        <div class="rounded-2xl bg-white border border-slate-200/60 shadow-sm p-8 text-center">
            <p class="text-sm text-slate-500">No forms available for your division.</p>
        </div>
    @endforelse
