    ...
    <div class="space-y-6">
        ...
        <x-filament::section>
            ...
            <ol style="list-style: decimal; padding-left: 1.25rem; font-size: 0.875rem; color: rgb(107 114 128); display: flex; flex-direction: column; gap: 0.25rem;">
                ...
                <li>Fill in the <strong style="font-weight: 600; color: rgb(75 85 99);">participants</strong> sheet — one participant per row.</li>
                <li>The <strong style="font-weight: 600; color: rgb(75 85 99);">name</strong> column is required. All other columns are optional.</li>
                <li>The <strong style="font-weight: 600; color: rgb(75 85 99);">division</strong> column must match an existing division name exactly (case-insensitive).</li>
                <li>The <strong style="font-weight: 600; color: rgb(75 85 99);">status</strong> column accepts <code>active</code> or <code>inactive</code> (defaults to <code>active</code>).</li>
                <li>Existing participants are matched by <strong>email</strong> (if provided) or <strong>identifier</strong> and will be updated. Soft-deleted participants are restored.</li>
                <li>Upload the completed file and click <em>Import Participants</em>.</li>
            </ol>
        ...
        <x-filament::section>
            ...
            @if (!empty($this->importErrors))
                <div style="margin-top: 1rem; border-radius: 0.5rem; border: 1px solid rgb(254 202 202); background: rgb(254 242 242); padding: 1rem;">
                    <p style="font-size: 0.875rem; font-weight: 600; color: rgb(153 27 27); margin-bottom: 0.5rem;">
                        {{ count($this->importErrors) }} warning(s):
                    </p>
            ...
            <div style="margin-top: 1rem; display: flex; align-items: center; justify-content: flex-end; gap: 0.75rem;">
                ...
                <x-filament::button
                    ...
                    wire:target="import"
                >
                    <span wire:loading.remove wire:target="import">Import Participants</span>
